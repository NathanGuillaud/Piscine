...
if (isset($tab_suivi) && isset($tab_suivi[0])){
  ...
  <caption>Suivi des contacts</caption>
  <thead>
        <tr>
            <th  onclick='sortTable(0)' scope='col'> Intéressé</th>
            <th  onclick='sortTable(1)' scope='col'> Présent</th>
            <th onclick='sortTable(2)' scope='col'> Nom Editeur</th>
